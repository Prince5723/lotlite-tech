...
const randomRotateY = () => {
  ...
  return (
    ...
    <div className="relative z-20 py-4 lg:py-20 max-w-7xl mx-auto">
      <div className="px-4">
        ...
        3500+ reviews and counting, from clients around the globe!
        </h4>
      </div>
    </div>
    ...
    <div className="relative grid grid-cols-1 md:grid-cols-2 gap-20">
      ...
      <div className="flex justify-between flex-col py-4">
        ...
        >
          <h3 className="text-2xl font-bold dark:text-white text-slate-300">
