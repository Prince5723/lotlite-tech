...
function Navbar({ className }: { className?: string }) {
  ...
  return (
    <div className="relative">
      ...
      <div
        className={cn("fixed top-10 inset-x-0 max-w-sm mx-auto z-40", className)}
      >
        <Menu setActive={setActive}>
          ...
          <MenuItem setActive={setActive} active={active} item="Services">
            <div className="flex flex-col space-y-4 text-sm">
              <HoveredLink href="/services">Training & Certification Programs</HoveredLink>
              <HoveredLink href="/services">Cybersecurity & Blockchain Solutions</HoveredLink>
              <HoveredLink href="/services">Enterprise Solutions & Business Software</HoveredLink>
              <HoveredLink href="/services">Web Development</HoveredLink>
              <HoveredLink href="/services">Consulting Services</HoveredLink>
            </div>
          </MenuItem>
